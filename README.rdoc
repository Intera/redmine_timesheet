...
This is a Redmine 2+ compatible version of the {plugin}[https://github.com/edavis10/redmine-timesheet-plugin] originally created by Eric Davis to generate timesheets from timelogs.
...
1. In your redmine plugins directory, run the command: `git clone https://github.com/arkhitech/redmine_timesheet.git redmine_timesheet`
